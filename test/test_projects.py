...
class ModuleData:
    ...
    def _add_module_data(self, current_id):
        ...
        projects_json = self._assert_req('/add/project', [ 
                                 { 'customer' : 'CUSTOMER', 'type' : 'TYPE', 'name' : 'PROJECTNAME1', 'description' : 'description', 'contact_person' : 'contact_person1', 'start' : '2000-01-02', 'end' : '2006-02-03', 'tasks' : [ 1, 2 ], 'grand_total' : 4, 'expences' : 4, 'responsible' : { '_id' : current_id, 'name' : 'Manag1'}, 'employees' : [ { '_id' : self.users_ids[1], 'name' : 'Emp1'} ] },
                                 { 'customer' : 'CUSTOMER1', 'type' : 'TYPE', 'name' : 'PROJECTNAME2', 'description' : 'description', 'contact_person' : 'contact_person2', 'start' : '2003-04-05', 'end' : '2010-05-06', 'tasks' : [ 2, 3 ], 'grand_total' : 4, 'expences' : 4, 'responsible' : { '_id' : self.users_ids[0], 'name' : 'Manag2'}, 'employees' : [ { '_id' : self.users_ids[0], 'name' : 'Emp2'} ] }, 
                                 { 'customer' : 'CUSTOMER3', 'type' : 'TYPE', 'name' : 'PROJECTNAME3', 'description' : 'description', 'contact_person' : 'contact_person3', 'start' : '2003-04-05', 'end' : '2010-05-06', 'tasks' : [ 2, 3 ], 'grand_total' : 4, 'expences' : 4, 'responsible' : { '_id' : self.users_ids[1], 'name' : 'Manag3'}, 'employees' : [ { '_id' : current_id, 'name' : 'Emp3'} ] } 
                                 ], 
                { 'error' : None, 'ids' : [ '', '', '' ] }
                )
...
class ReportUsersHoursAPIAsManager(TestCaseAsManager, ModuleData):
    ...
    def test_project_ko(self):
        ...
        # Try to insert
        self._assert_req('/add/project', [ { 'customer' : 'CUSTOMER', 'type' : 'TYPE', 'name' : 'PROJECTNAME1', 'description' : 'description', 'contact_person' : 'contact_person1', 'start' : '2000-01-02', 'end' : '2006-02-03', 'tasks' : [ 1, 2 ], 'grand_total' : 4, 'expences' : 4, 'responsible' : { '_id' : self.users_ids[1], 'name' : 'Manag1'}, 'employees' : [ { '_id' : self.users_ids[1], 'name' : 'Emp1'} ] } ], 
                { 'error' : "TSValidationError: Action 'add' in 'project' is restricted for current user", 'ids' : [  ] }
                )

        # Update project that does not manage
        self._assert_req('/update/project', { '_id' : self.projects_ids[1], 'customer' : 'CUSTOMERZ', 'type' : 'TYPE', 'name' : 'PROJECTNAME1', 'description' : 'description', 'contact_person' : 'contact_person1', 'start' : '2000-01-02', 'end' : '2006-02-03', 'tasks' : [ 1, 2 ], 'grand_total' : 4, 'expences' : 4, 'responsible' : { '_id' : self.manager_id, 'name' : 'Manag1'}, 'employees' : [ { '_id' : self.manager_id, 'name' : 'Emp1'} ] },  { 'error' : "ValidationError: u'%s' is not one of ['%s']" % (self.projects_ids[1], str(self.projects_ids[0]) ) } )
...
class ReportUsersHoursAPIAsEmployee(TestCaseAsEmployee, ModuleData):
    ...
    def test_project_ko(self):
        ...
        # Update project 
        self._assert_req('/update/project', { '_id' : self.projects_ids[0], 'customer' : 'CUSTOMERZ', 'type' : 'TYPE', 'name' : 'PROJECTNAME1', 'description' : 'description', 'contact_person' : 'contact_person1', 'start' : '2000-01-02', 'end' : '2006-02-03', 'tasks' : [ 1, 2 ], 'grand_total' : 4, 'expences' : 4, 'responsible' : { '_id' : self.employee_id, 'name' : 'Manag1'}, 'employees' : [ { '_id' : self.employee_id, 'name' : 'Emp1'} ] },  { 'error' : "TSValidationError: Action 'update' in 'project' is restricted for current user" } )
