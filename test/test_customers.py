...
class CustomerAPIAsAdmin(TestClassBase):
    ...
    def test_customer_ok(self):
        ...
        customer_json = self._assert_req('/add/customer', [ { 'name' : 'CUSTOMERTEST', 'address' : 'CUSTOMER STREET', 'phone' : '123456789', 'contact_person' : 'CUSTO1', 'vat_number' : 'CUSTOVAT', 'website' : 'CUSTOWEB', 'city' : 'CITY', 'country' : 'COUNTRY', 'postal_code' : '0101', 'email' : 'CUSTOMAIL', 'description' : 'CUSTODESC' } ], { 'error' : None, 'ids' : [ '' ] })
...
class CustomerAPIAsEmployee(TestCaseAsEmployee):
    ...
    def test_customer_ko(self):
        # TODO: test /get/ (should be restricted?)
        ...
        self._assert_req('/add/customer', [ { 'name' : 'CUSTOMERTEST', 'address' : 'CUSTOMER STREET', 'phone' : '123456789', 'contact_person' : 'CUSTO1', 'vat_number' : 'CUSTOVAT', 'website' : 'CUSTOWEB', 'city' : 'CITY', 'country' : 'COUNTRY', 'postal_code' : '0101', 'email' : 'CUSTOMAIL', 'description' : 'CUSTODESC' } ], {u'error': u"TSValidationError: Action 'add' in 'customer' is restricted for current user", 'ids' : []})
