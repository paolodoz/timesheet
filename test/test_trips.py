...
class ModuleData:
    ...
    def _add_module_data(self, current_id):
        ...
        projects_json = self._assert_req('/add/project', [ 
                                 ...
                                 { 'customer' : 'CUSTOMER1', 'tags' : [ 'TYPE' ], 'name' : 'PROJECTNAME2', 'description' : 'description', 'contact_person' : 'contact_person', 'start' : '2003-04-05', 'end' : '2010-05-06', 'tasks' : [ 2, 3 ], 'grand_total' : 4, 'responsible' : { '_id' : '1'*24, 'name' : 'Manag2'}, 'employees' : [ { '_id' :current_id, 'name' : 'Emp2'} ], 'trips' : [ 
                                                 ...
                                                 { '_id' : '9'*24, "user_id" : current_id, "description" : "descr1", "status" : 1, "start" : "2010-10-08", "end" : "2010-10-10", "country" : "Italy", 'city' : "Rome", 'note' : 'approved', 'accommodation' : {} }     
                                 ] }, 
...
class TripsAPIAsAdmin(TestClassBase, ModuleData):
    ...
    def test_trips_ok(self):
        ...
        self._assert_req('/data/push_trips', [ 
                                { '_id' : self.projects_ids[0], 
                                 "trips" : [ 
                                                 { "user_id" : self.users_ids[0], "description" : "descr3", "status" : 2, "start" : "2009-10-08", "end" : "2009-10-10", "country" : "USA", 'city' : "Austin", 'note' : 'too expensive', 'accommodation' : {} },     
                                                 { "user_id" : self.users_ids[1], "description" : "descr4", "status" : 0, "start" : "2009-10-08", "end" : "2009-10-10", "country" : "Austria", 'city' : "Wien", 'note' : 'approved', 'accommodation' : {} }     
                                ] } ], 
               { 'error' : None, 'ids' : [ '', '' ] }
               )
