...
class ModuleData:
    def _add_module_data(self, current_id):
        ...
        uri = '/add/project'
        json_in = [
                    { 'name' : 'MANAGEDPROJECT1', 'customer' : 'CUSTOMER1', 'type' : 'TYPE1', 'description' : 'description1', 'contact_person' : 'contact_person1', 'start' : '2000-01-02', 'end' : '2000-01-03', 'tasks' : [ 'task1', 'task2' ], 'grand_total' : 4, 'responsible' : { '_id' : self.manager_id, 'name' : 'The manager'}, 'employees' : [ { '_id' : '1'*24, 'name' : 'The employed administrator'} ] }, 
                    { 'name' : 'MANAGEDPROJECT2', 'customer' : 'CUSTOMER2', 'type' : 'TYPE2', 'description' : 'description2', 'contact_person' : 'contact_person2', 'start' : '2000-01-01', 'end' : '2000-01-05', 'tasks' : [ 'task1', 'task2' ], 'grand_total' : 4, 'responsible' : { '_id' : self.manager_id, 'name' : 'The manager'}, 'employees' : [ { '_id' : '7'*24, 'name' : 'Another employee'} ] } 
                    ]
